      ...
      {!weatherData ? (
        ...
        <input type="email" placeholder="Search City..."
          ...
          <button type="button" class=" inset-y-0 end-0 flex items-center justify-center p-3 bg-[#007bff] border-x border-x-white" onClick={startListening}>
            <svg class="w-4 h-4  text-gray-500 dark:text-white hover:text-gray-900 dark:hover:text-white" aria-hidden="true" xmlns="https://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
        ...
        <button type='button' class="flex items-center justify-center bg-[#007bff] px-5" onClick={getCityPos}>
          <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 192.904 192.904" width="16px" class="fill-white">
            <path
